...
This project serves as a continuation of the pairing model with the aim being to solve the same problem but now by developing
...
\subex{d)}
Compare your results with those from the exact diagonalization with and without the $4p4h$ excitation. Compare also your results to perturbation theory at different orders, in particular to second order. Discuss your results.  If other students are solving the same problem using Green's function theory, you can also compare your results with those obtained from Green's function theory. The aim is to finalize this part during the first week. The codes you will develop can be used as a starting point for the second part of the project. In the second part you can focus on either infinite nuclear matter in a cartesian basis or finite nuclei.
...
\subsection*{Project \thedoconceexercisecounter: Green's function calculations with two-particle and two-hole correlations only for the pairing model}
...
\subex{b)}
Set up the Green's function equations for two-particle and two-hole correlations and convince yourself about their meaning and correctness.

\subex{c)}
Write a class which holds single-particle data like specific quantum numbers, single-particle Hamiltonian etc. Write also a class which sets up and stores two-body matrix elements defined by the single-particle states.  Write thereafter functions/classes which implement the Green's function method with two-particle and two-hole correlations only.

\subex{d)}
Compare your results with those from the exact diagonalization with and without the $4p4h$ excitation. Compare also your results to perturbation theory at different orders, in particular to second order. Discuss your results. If other groups are solving the same problem with the coupled cluster method, discuss these results as well. The aim is to finalize this part during the first week. The codes you will develop can be used as a starting point for the second part of the project. In the second part you can focus on either infinite nuclear matter in a cartesian basis or finite nuclei.
...
\subsection*{Project \thedoconceexercisecounter: Green's function calculations with two-particle and two-hole correlations only for infinite nuclear matter}
...
\subex{d)}
Use the program you developed in connection with the pairing model to perform Green's function calculations in infinite matter with two-particle and two-hole correlations.
Perform Green's function calculations for infinite nuclear matter with the Minnesota interaction for different particle numbers 
Limit yourself to two-particle and two-hole intermediate excitations only.
