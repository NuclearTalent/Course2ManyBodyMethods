# -*- coding: utf-8 -*-
#
# Introduction and Motivation documentation build configuration file, created by
# sphinx-quickstart on Tue Jun  9 06:45:11 2015.
#
...
project = u'Introduction and Motivation'
copyright = u'2015, "Morten Hjorth-Jensen":"http://computationalphysics.no", National Superconducting Cyclotron Laboratory and Department of Physics and Astronomy, Michigan State University, East Lansing, MI 48824, USA & Department of Physics, University of Oslo, Oslo, Norway'
author = u'"Morten Hjorth-Jensen":"http://computationalphysics.no", National Superconducting Cyclotron Laboratory and Department of Physics and Astronomy, Michigan State University, East Lansing, MI 48824, USA & Department of Physics, University of Oslo, Oslo, Norway'
...
html_title = "Introduction and Motivation"
...
htmlhelp_basename = 'IntroductionandMotivationdoc'
...
latex_documents = [
  (master_doc, 'IntroductionandMotivation.tex', u'Introduction and Motivation Documentation',
   u'"Morten Hjorth-Jensen":"http://computationalphysics.no", National Superconducting Cyclotron Laboratory and Department of Physics and Astronomy, Michigan State University, East Lansing, MI 48824, USA \\& Department of Physics, University of Oslo, Oslo, Norway', 'manual'),
]
...
man_pages = [
    (master_doc, 'introductionandmotivation', u'Introduction and Motivation Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IntroductionandMotivation', u'Introduction and Motivation Documentation',
   author, 'IntroductionandMotivation', 'One line description of project.',
   'Miscellaneous'),
]
